...
namespace CSharpTutA.cs
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (TextWriter tw = new StreamWriter(@"D:\test\bowser.xml"))
            {
            ...
            //TextReader reader = new StreamReader(@"D:\test\bowser.xml");
            ...
            //using (Stream fs = new FileStream(@"D:\test\bowser.xml",
            ...
            //using (FileStream fs2 = File.OpenRead(@"D:\test\bowser.xml"))
            //{
